...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            _checkAnswerBtn        = _answers + ' input' ,
        ...
        plugin.method = {
            ...
            startQuiz: function(options) {
                ...
                function start(options) {
                    ...
                    if (firstQuestion.length) {
                        firstQuestion.fadeIn(1000, function () {
                            if (options && options.callback) options.callback ();
                        });
                    }
                }
                $(".terminal-content li").remove();
            ...
            checkAnswer: function(checkButton, options) {
                ...
                // Jack: Modified to always show the correct response no matter what
